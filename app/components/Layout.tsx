      ...
      case 'home':
        return (
          <div className="p-6 bg-black rounded-lg">
            ...
            <Button className="w-full mt-6 bg-[#00FF88] text-black hover:bg-[#00CC6A]">Start a New Battle</Button>
          </div>
        )
      case 'battle':
        return (
          <div className="p-6 bg-black rounded-lg">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-4">
                {battleRooms.map((room) => (
                  <div key={room.id} className="bg-[#111111] p-4 rounded-lg flex items-center justify-between">
                    <div>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button className="w-full bg-[#00FF88] text-black hover:bg-[#00CC6A]">Create Battle Room</Button>
              </DialogTrigger>
              <DialogContent className="bg-[#111111] text-white">
                ...
                <Button className="w-full bg-[#00FF88] text-black hover:bg-[#00CC6A]">Create Battle</Button>
              </DialogContent>
            </Dialog>
          </div>
        )
          ...
          <div className="p-6 bg-black rounded-lg">
              ...
              <TabsContent value="traders">
                <div className="space-y-4">
                  {traders.map((trader, index) => (
                    <div key={trader.name} className="bg-[#111111] p-4 rounded-lg cursor-pointer" onClick={() => setSelectedTrader(trader)}>
              ...
              <TabsContent value="guilds">
                <div className="space-y-4">
                  {guilds.map((guild, index) => (
                    <div key={guild.name} className="bg-[#111111] p-4 rounded-lg cursor-pointer" onClick={() => setSelectedGuild(guild)}>
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-4">
                          <Avatar className="h-10 w-10 border-2 border-[#00FF88]">
            ...
            {selectedTrader && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                <div className="bg-[#111111] p-6 rounded-lg max-w-md w-full">
                  ...
                  <Button className="w-full bg-[#00FF88] text-black hover:bg-[#00CC6A]">Challenge Trader</Button>
                </div>
              </div>
            )}
            {selectedGuild && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                <div className="bg-[#111111] p-6 rounded-lg max-w-md w-full">
                  ...
                  <Button className="w-full bg-[#00FF88] text-black hover:bg-[#00CC6A]">Join Guild</Button>
                </div>
              </div>
            )}
          </div>
      ...
      case 'overview':
        return (
          <div className="p-6 bg-black rounded-lg">
            ...
            <Button className="w-full bg-[#00FF88] text-black hover:bg-[#00CC6A]">Start a New Battle</Button>
          </div>
        )
      default:
        return null
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <span className="text-2xl font-bold bg-gradient-to-r from-[#00FF88] to-[#00FFE0] bg-clip-text text-transparent">
                CryptoClash
              </span>
            ...
            <div className="hidden md:block">
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <div className="ml-3 relative">
                  <div className="flex items-center">
                    <Avatar className="h-8 w-8 rounded-full border-2 border-[#00FF88]">
                ...
                <Button className="ml-4 bg-[#1A1A1A] text-white hover:bg-[#252525] border border-[#333333]">
